...
final class DeptracExtensionTest extends TestCase
{
    ...
    public function testDefaults(): void
    {
        ...
        self::assertSame(['types' => [EmitterType::CLASS_TOKEN->toString(), EmitterType::FUNCTION_TOKEN->toString()]], $this->container->getParameter('analyser'));
    ...
    public function testAnalyserWithDuplicateTypes(): void
    {
        $configs = [
            'deptrac' => [
                'analyser' => [
                    'types' => [EmitterType::CLASS_TOKEN->toString(), EmitterType::CLASS_TOKEN->toString()],
                ],
            ],
        ];
